    ...
    <div className="relative inline-block text-left">
      ...
      {isOpen && (
        <div
          ...
          } mt-2 w-56 rounded-md  dark:bg-gray-800 shadow-lg ring-1 ring-black dark:ring-gray-700 ring-opacity-9 focus:outline-none z-50`}
          role="menu"
  ...
  return (
    <div className="relative w-[64px]" data-expanded={isExpanded}>
      ...
      <div className="relative">
        ...
        {/* Other items - now positioned above */}
            ...
            style={{
              ...
              clipPath:
                index === childrenArray.length - 2
                  ? "circle(50% at 50% 50%)"
                  : "circle(50% at 50% 45%)", // Adjusted clip path for upward direction
